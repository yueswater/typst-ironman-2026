...
[上一篇](https://ithelp.ithome.com.tw/articles/10403242)練了底線、刪除線、上標下標這些文字裝飾，也學會用 `text` 函式客製化字型、字級與顏色。這篇要換個方向，回頭把清單語法補完，再補上連結、標籤引用這些寫文件時常會遇到，但前面還沒提過的重要語法。
...
![清單進階範例輸出](images/list-advanced-output.png)
...
![連結語法範例輸出](images/link-syntax-output.png)
...
![標籤與引用範例輸出](images/label-ref-output.png)
...
![常用標記語法範例輸出](images/misc-marks-output.png)
